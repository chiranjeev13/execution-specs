...
class Withdrawal:
    ...
    [`block`]: ref:ethereum.forks.bogota.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.forks.bogota.fork.EMPTY_OMMER_HASH
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.forks.bogota.state.state_root
    [Trie]: ref:ethereum.forks.bogota.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.forks.bogota.trie.root
    [Trie]: ref:ethereum.forks.bogota.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.forks.bogota.bloom.logs_bloom
    """
    ...
    [crh]: ref:ethereum.forks.bogota.requests.compute_requests_hash
    ...
    [cbalh]: ref:ethereum.forks.bogota.block_access_lists.rlp_utils.compute_block_access_list_hash
    """  # noqa: E501
...
class Block:
    ...
    [withdrawals]: ref:ethereum.forks.bogota.blocks.Withdrawal
    """
    ...
    [headers]: ref:ethereum.forks.bogota.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.bogota.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.bogota.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.bogota.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.bogota.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.bogota.vm.instructions.log.log4
    """
