...
[`BlockAccessList`]: ref:ethereum.forks.bogota.block_access_lists.rlp_types.BlockAccessList  # noqa: E501
"""
...
def ensure_account(builder: BlockAccessListBuilder, address: Address) -> None:
    ...
    [`AccountData`] :
        ref:ethereum.forks.bogota.block_access_lists.builder.AccountData
...
def add_touched_account(
    ...
    [`EXTCODEHASH`] :
        ref:ethereum.forks.bogota.vm.instructions.environment.extcodehash
    [`BALANCE`] :
        ref:ethereum.forks.bogota.vm.instructions.environment.balance
    [`EXTCODESIZE`] :
        ref:ethereum.forks.bogota.vm.instructions.environment.extcodesize
    [`EXTCODECOPY`] :
        ref:ethereum.forks.bogota.vm.instructions.environment.extcodecopy
...
def build_block_access_list(
    ...
    [`BlockAccessList`]: ref:ethereum.forks.bogota.block_access_lists.rlp_types.BlockAccessList  # noqa: E501
    [`StateChanges`]: ref:ethereum.forks.bogota.state_tracker.StateChanges
